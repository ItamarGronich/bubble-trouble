(function (P, H) {
    ...
    function animateXY(bubble, initialVerticalSpeed, horizontalSpeed, moment) {
        ...
        function calculatePos(time) {
            return [bubbleStats.left + P.horizontalDistance(horizontalSpeed, time), bubbleStats.top + P.verticalDistance(initialVerticalSpeed, time)];
        }
        ...
        function step(HRTimeStamp) {
            ...
            if (!H.isCollide(bubble, footer) && !H.isCollide(bubble, leftWall) && !H.isCollide(bubble, rightWall) && !H.isCollide(bubble, topWall)) {
...
//# sourceMappingURL=bubble-animation-compiled.js.map